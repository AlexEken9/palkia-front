...
function ComparisonCard({ title, time, description, isOld = false, delay = 0 }: ComparisonCardProps) {
    return (
        <motion.div
            initial="hidden"
            whileInView="visible"
            ...
            className={`
                relative p-8 rounded-2xl border opacity-0 transition-colors duration-500
                ${isOld
            ...
            <div className="max-w-6xl mx-auto">
                <div className="text-center mb-16">
                    <motion.div
                        ...
                        className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-palkia-500/10 border border-palkia-500/20 text-palkia-400 text-xs font-medium mb-4 opacity-0"
                    >
                ...
                <div className="relative flex justify-center">
                    ...
                    <motion.div
                        ...
                        viewport={{ once: true, amount: 0.5 }}
                        className="relative z-10 glass-panel px-10 py-6 rounded-full border border-palkia-500/30 flex items-center gap-4 shadow-[0_0_50px_rgba(242,29,120,0.15)] opacity-0"
                    >
